...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\BG1NPC-26') Then
		FileWrite($g_LogFile, '>BG1NPC-26\* .' & @CRLF)
		_Extract_MoveMod('BG1NPC-26')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\EET-13.0') Then
		FileWrite($g_LogFile, '>EET-13.0\* .' & @CRLF)
		_Extract_MoveMod('EET-13.0')
	EndIf
	...
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\FishingForTrouble-3.2.7') Then
		...
		_Extract_MoveMod('FishingForTrouble-3.2.7')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\HTaM-v.2.9') Then
		FileWrite($g_LogFile, '>HTaM-v.2.9\* .' & @CRLF)
		_Extract_MoveMod('HTaM-v.2.9')
	EndIf
