...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\DragonspearUI-21.12.0') Then
		FileWrite($g_LogFile, '>DragonspearUI-21.12.0\* .' & @CRLF)
		_Extract_MoveMod('DragonspearUI-21.12.0')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Tamoko-0.8') Then
		FileWrite($g_LogFile, '>Tamoko-0.8\* .' & @CRLF)
		_Extract_MoveMod('Tamoko-0.8')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Scales_of_Balance-5.34') Then
		FileWrite($g_LogFile, '>Scales_of_Balance-5.34\* .' & @CRLF)
		_Extract_MoveMod('Scales_of_Balance-5.34')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\DrizztSaga-3.03') Then
		FileWrite($g_LogFile, '>DrizztSaga-3.03\* .' & @CRLF)
		_Extract_MoveMod('DrizztSaga-3.03')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\HTaM-v.3.6.2') Then
		FileWrite($g_LogFile, '>HTaM-v.3.6.2\* .' & @CRLF)
		_Extract_MoveMod('HTaM-v.3.6.2')
	EndIf
