...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\DragonspearUI-21.09.0') Then
		FileWrite($g_LogFile, '>DragonspearUI-21.09.0\* .' & @CRLF)
		_Extract_MoveMod('DragonspearUI-21.09.0')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Enhanced-Powergaming-Scripts-5.2') Then
		FileWrite($g_LogFile, '>Enhanced-Powergaming-Scripts-5.2\* .' & @CRLF)
		_Extract_MoveMod('Enhanced-Powergaming-Scripts-5.2')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\HTaM-v.3.5.1') Then
		FileWrite($g_LogFile, '>HTaM-v.3.5.1\* .' & @CRLF)
		_Extract_MoveMod('HTaM-v.3.5.1')
	EndIf
