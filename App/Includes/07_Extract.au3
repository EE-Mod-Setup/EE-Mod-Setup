...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\d5_Random_Tweaks-1.5.2.1') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Enhanced-Powergaming-Scripts-7.1') Then
		FileWrite($g_LogFile, '>Enhanced-Powergaming-Scripts-7.1\* .' & @CRLF)
		_Extract_MoveMod('Enhanced-Powergaming-Scripts-7.1')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Scales_of_Balance-5.38.2') Then
		FileWrite($g_LogFile, '>Scales_of_Balance-5.38.2\* .' & @CRLF)
		_Extract_MoveMod('Scales_of_Balance-5.38.2')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\HTaM-v.4.2.4') Then
		FileWrite($g_LogFile, '>HTaM-v.4.2.4\* .' & @CRLF)
		_Extract_MoveMod('HTaM-v.4.2.4')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\tipun_gui_mod-2.0') Then
		FileWrite($g_LogFile, '>tipun_gui_mod-2.0\* .' & @CRLF)
		_Extract_MoveMod('tipun_gui_mod-2.0')
	EndIf
