...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Tweaks-Anthology-10_RC1') Then
		FileWrite($g_LogFile, '>Tweaks-Anthology-10_RC1\* .' & @CRLF)
		_Extract_MoveMod('Tweaks-Anthology-10_RC1')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Scales_of_Balance-5.33.4') Then
		FileWrite($g_LogFile, '>Scales_of_Balance-5.33.4\* .' & @CRLF)
		_Extract_MoveMod('Scales_of_Balance-5.33.4')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\HTaM-v.3.5.2') Then
		FileWrite($g_LogFile, '>HTaM-v.3.5.2\* .' & @CRLF)
		_Extract_MoveMod('HTaM-v.3.5.2')
	EndIf
