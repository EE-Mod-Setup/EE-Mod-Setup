...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Travellers-0.83') Then
		FileWrite($g_LogFile, '>Travellers-0.83\* .' & @CRLF)
		_Extract_MoveMod('Travellers-0.83')
	EndIf
