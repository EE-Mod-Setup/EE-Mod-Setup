...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Ascalons_Questpack-4.3') Then
		FileWrite($g_LogFile, '>Ascalons_Questpack-4.3\* .' & @CRLF)
		_Extract_MoveMod('Ascalons_Questpack-4.3')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Edwin_Romance-3.0') Then
		FileWrite($g_LogFile, '>Edwin_Romance-3.0\* .' & @CRLF)
		_Extract_MoveMod('Edwin_Romance-3.0')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Tweaks-Anthology-15') Then
		FileWrite($g_LogFile, '>Tweaks-Anthology-15\* .' & @CRLF)
		_Extract_MoveMod('Tweaks-Anthology-15')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\XulayeEet-2.4') Then
		FileWrite($g_LogFile, '>XulayeEet-2.4\* .' & @CRLF)
		_Extract_MoveMod('XulayeEet-2.4')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Scales_of_Balance-6.1') Then
		FileWrite($g_LogFile, '>Scales_of_Balance-6.1\* .' & @CRLF)
		_Extract_MoveMod('Scales_of_Balance-6.1')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\HTaM-v.4.2.6') Then
		FileWrite($g_LogFile, '>HTaM-v.4.2.6\* .' & @CRLF)
		_Extract_MoveMod('HTaM-v.4.2.6')
	EndIf
