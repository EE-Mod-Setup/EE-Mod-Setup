...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Ajantis_BG1_Expansion-16') Then
		FileWrite($g_LogFile, '>Ajantis_BG1_Expansion-16\* .' & @CRLF)
		_Extract_MoveMod('Ajantis_BG1_Expansion-16')
	EndIf
