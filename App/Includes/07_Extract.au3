...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\d5_Random_Tweaks-1.5.1') Then
		FileWrite($g_LogFile, '>d5_Random_Tweaks-1.5.1\* .' & @CRLF)
		_Extract_MoveMod('d5_Random_Tweaks-1.5.1')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\EEUITweaks-3.8.1') Then
		FileWrite($g_LogFile, '>EEUITweaks-3.8.1\* .' & @CRLF)
		_Extract_MoveMod('EEUITweaks-3.8.1')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Enhanced-Powergaming-Scripts-6.4') Then
		FileWrite($g_LogFile, '>Enhanced-Powergaming-Scripts-6.4\* .' & @CRLF)
		_Extract_MoveMod('Enhanced-Powergaming-Scripts-6.4')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Tweaks-Anthology-14') Then
		FileWrite($g_LogFile, '>Tweaks-Anthology-14\* .' & @CRLF)
		_Extract_MoveMod('Tweaks-Anthology-14')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Scales_of_Balance-5.38.1') Then
		FileWrite($g_LogFile, '>Scales_of_Balance-5.38.1\* .' & @CRLF)
		_Extract_MoveMod('Scales_of_Balance-5.38.1')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Enhanced-Powergaming-Scripts-7.0') Then
		FileWrite($g_LogFile, '>Enhanced-Powergaming-Scripts-7.0\* .' & @CRLF)
		_Extract_MoveMod('Enhanced-Powergaming-Scripts-7.0')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\HTaM-v.4.2.2') Then
		FileWrite($g_LogFile, '>HTaM-v.4.2.2\* .' & @CRLF)
		_Extract_MoveMod('HTaM-v.4.2.2')
	EndIf
