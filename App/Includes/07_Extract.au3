...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\SoDBanterEET-0.5') Then
		FileWrite($g_LogFile, '>SoDBanterEET-0.5\* .' & @CRLF)
		_Extract_MoveMod('SoDBanterEET-0.5')
	EndIf
