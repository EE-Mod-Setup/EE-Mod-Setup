...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\SwordCoastStratagems-33.3') Then
		FileWrite($g_LogFile, '>SwordCoastStratagems-33.3\* .' & @CRLF)
		_Extract_MoveMod('SwordCoastStratagems-33.3')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\A7-NPCGenerator-1.1') Then
		FileWrite($g_LogFile, '>A7-NPCGenerator-1.1\* .' & @CRLF)
		_Extract_MoveMod('A7-NPCGenerator-1.1')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Scales_of_Balance-5.23') Then
		FileWrite($g_LogFile, '>Scales_of_Balance-5.23\* .' & @CRLF)
		_Extract_MoveMod('Scales_of_Balance-5.23')
	EndIf
