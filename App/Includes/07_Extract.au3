...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\BG1NPC-28') Then
		FileWrite($g_LogFile, '>BG1NPC-28\* .' & @CRLF)
		_Extract_MoveMod('BG1NPC-28')
	EndIf
