...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\SwordCoastStratagems-34.2') Then
		FileWrite($g_LogFile, '>SwordCoastStratagems-34.2\* .' & @CRLF)
		_Extract_MoveMod('SwordCoastStratagems-34.2')
	EndIf
