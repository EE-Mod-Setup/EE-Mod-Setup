...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\DragonspearUI-22.01.2') Then
		FileWrite($g_LogFile, '>DragonspearUI-22.01.2\* .' & @CRLF)
		_Extract_MoveMod('DragonspearUI-22.01.2')
	EndIf
