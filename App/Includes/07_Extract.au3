...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWS|BG1EE|BG2EE|PSTEE|IWD1EE') And FileExists($g_GameDir&'\Subrace-mod-0.2.2') Then
		FileWrite($g_LogFile, '>Subrace-mod-0.2.2\* .' & @CRLF)
		_Extract_MoveMod('Subrace-mod-0.2.2')
	EndIf
